...
typedef std::shared_ptr < CommaDelimiterNode > CommaDelimeterNodePtr;

class CoordinateNode : public Node {
public: CoordinateNode(const NodePtr &number1, const NodePtr &comma1, const NodePtr &number2, const NodePtr &comma2, const NodePtr &number2);
public: int type() const;
public: void print(std::ostream &out) const;
}
